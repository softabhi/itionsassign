...
const Hero = () => {
  ...
  const {moviesList} = useContext(MyContext)
  ...
  const records = moviesList.slice(firstIndex, lastIndex);
              ...
              <div key={index} className="col-6 col-lg-3 mt-3 cart_item">
                <div className="card p-2" style={{ width: "" }}>
                  ...
                  <div className="card-body card-main">
                    ...
                    <h6 className='text-size'><span className='text-success '>Imdbmovieid:</span>{item.imdbmovieid}</h6>
                    <h6 id='rating'>
                      <BsStarFill />
                      <BsStarFill />
                      <BsStarFill />
